		...
		$(function() {
			$("#join-form").submit(function() {
				...
				if($("#email").val() == "") {
					...
					$("#dialog p").text("이메일은 필수 입력 항목입니다.").dialog();
					$("#email").focus();
					return false;
				}
...
<body>
		...
		<div id="content">
			<div id="user">
				...
				<form id="join-form" name="joinForm" method="post" action="/mysite3/user">
					...
					<img id="img-chkemail" style="width:15px; display:none" src="${pageContext.request.contextPath}/assets/images/check.png" >
	...
	<div id="dialog" title="가입 폼 체크" style="display:none">
  		<p>이름은 필수 입력 항목입니다.</p>
	</div>
</body>
</html>